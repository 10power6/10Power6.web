...
export default function AboutCTA({ onStartProject, theme = "dark" }) {
  return (
    <ServiceSection theme={theme} ariaLabelledBy="about-cta-heading">
      <motion.article
      ...
      >
        <div className="flex flex-col gap-8 lg:flex-row lg:items-center lg:justify-between">
          <header className="max-w-3xl">
            ...
            <h2 id="about-cta-heading" className="mt-4 text-3xl font-semibold text-white sm:text-4xl">
          ...
          <div className="shrink-0">
            <button
              ...
              className="inline-flex w-full items-center justify-center gap-2 rounded-full bg-indigo-500 px-8 py-3.5 text-sm font-semibold text-white shadow-lg shadow-indigo-500/20 transition hover:bg-indigo-400 sm:w-auto"
            >
              Start Your Project
